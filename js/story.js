...
window.addEventListener("load", (event) => {
    ...
    window.addEventListener('scroll', (event) => {
        ...
        if(Math.abs(scroller.getScrollPosition() + document.documentElement.clientHeight - scrollHeight) < 100){
            ...
            // 데이터를 가져오는데 시간이 오래 걸릴 경우
            // 100개 정도의 데이터를 미리 가져와서 배열에 담은 다음에
            // 10개씩 보여주면 됨.
        ...
        <div class="blog">
            ...
            <div class="middle">
                <ul>
                    ...
                    <li>
                        <p>성산의 해안도로를 따라 달리다 보면 보이는 오른 카페는 
                        제주도의 자연요소 중 하나인 오름을 모티브로 한 카페의 콘셉트인 만큼 
                        자연과 함께 커피를 마시며 즐길 수 있었던 것 같아요.😋</p>
                    </li>
                    <li>
                        <ul>
                            <li>
